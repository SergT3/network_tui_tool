...
from NetworkObjectFrames.network_object_attributes import ovs_dpdk_bond, common_check, common_text, common_list, ovs_common
from interruptframe import InterruptFrame


class OVSDpdkBondModel(object):
    pass


class OVSDpdkBondFrame(InterruptFrame):
