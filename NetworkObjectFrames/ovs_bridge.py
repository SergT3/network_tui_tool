...
from NetworkObjectFrames.network_object_attributes import ovs_bridge, common_check, common_text, common_list, ovs_common
...
class OVSBridgeFrame(InterruptFrame):
